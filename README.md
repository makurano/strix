...
# アプリケーション名
## STRIX
[![Image from Gyazo](https://i.gyazo.com/fa4f518e75334fbed9f1941a23b7bd51.png)](https://gyazo.com/fa4f518e75334fbed9f1941a23b7bd51)

# アプリケーション概要
STRIXは若い研究者と、研究者を目指す人々のためのwebアプリケーションです。<br>
キャリアを形成する最中の研究者にとって必要な**ポートフォリオを誰でも手軽に作ってほしい**という思いから生まれました。<br>
きっかけは、研究者を目指す友人との会話から発想を得たことにあります。<br>
具体的な要望として下記の2点がありました。<br>

**1.「非常勤講師や転勤の多い若手として大学のシステムに頼りたくない」**<br>
&emsp;→機関から独立したシステムの作成<br>
&emsp;→全ての学生に発信できるよう講義資料カテゴリーの導入<br>
**2.「個人のポートフォリオは誰かに依頼して作ってもらっている」**<br>
&emsp;→idパラメーターの使えるrailsで実質的に個人ページを所有できる<br>

上記の要望を踏まえてSTRIXは全てのユーザーが使いやすいような設計をしています。<br>
研究論文、講義資料などを公開することができ、**研究者が自らマイページを作り上げ業績などを発信する**ことができます。<br>
また、その研究者から指導を受ける学生にとっても大学などの機関のシステムに依存することなく講義資料を手に入れやすくしました。

## 特にこだわった点
実際に研究職を目指す学生からヒアリングを得て、若手研究者ならではの悩みを解決する機能があります。<br>
### 1.誰でも使いやすいシンプルなデザイン
ダウンロードボタン・カテゴリータブなどのように機関関係者や学生が直感的にアクセスできるよう、<br>
トップページからの各機能へのアクセスが豊富かつ、シンプルなデザインを心がけました。
  
### 2.マークダウン表示機能
研究者がSTRIXをポートフォリオとして利用する際、プロフィールページにオリジナリティを持たせられるように、<br>
マークダウン表示機能を実装し、強調したい実績や研究分野をアピールできるようにしています。
...
# 今後の実装について
- 検索機能の充実（検索後のさらなる絞り込みなど）
- ダウンロードユーザーの制限（パスワード要求など）
